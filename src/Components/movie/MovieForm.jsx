      ...
      <div className="relative p-4 w-full max-w-md max-h-full">
        <div id="crud" className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <form onSubmit={handleSubmit} encType="multipart/form-data" className="p-4 md:p-5">
            ...
            <button
              type="submit"
              className="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Submit
            </button>
          </form>
