          ...
          <div className="max-w-2xl mx-auto px-4">
            ...
            {comments.length > 0 ? (
              comments.map((comment) => (
                <article key={comment.id} className="p-6 text-base  mb-3">
                  <footer className="flex justify-between items-center mb-2">
                    ...
                    <button
                      className="inline-flex items-center p-2 text-2xl font-medium text-gray-500 dark:text-gray-400  focus:ring-4"
                      type="button"
                    >
              ...
              <div className="p-6 text-base bg-white rounded-lg dark:bg-gray-900 mb-3 text-center text-gray-500 dark:text-gray-400">
